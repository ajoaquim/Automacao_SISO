...
@TID18890REV0.3.0 @18890 @gestao-prestador
...
Background: 
    ...
    When optar por selecionar o menu Gestão Prestadores Odontológicos e Cadastro Usuário
	...
	Scenario: Criar um novo usuário 
		When Informar um login ainda não cadastrado na tela de cadastro usuario
        And clicar fora do campo na tela de cadastro usuario
        And escolher o Tipo de usuário na tela de cadastro usuario
        And preencher os dados de inclusão na tela de cadastro usuario
        And clicar no botão Incluir na tela de cadastro usuario
		And o sistema apresenta a mensagem Usuário Alterado na tela de cadastro do usuario
        Then o login é criado para o Portal Desejado na tela de cadastro usuario
